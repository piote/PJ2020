...
<body>
	...
	<h1 class="text-center font-weight-bold">정보게시판</h1>
			...
			<div class="form-group">
				...
				<label><%=dto.getI_TITLE() %></label>
			</div>
			<div class="form-group">
				<label for="id">날짜</label>
				<label><%=dto.getI_DATE() %></label>
			</div>
			<div class="form-group">
				<label for="id">내용</label>
				<label><%=dto.getI_CONTENT() %></label>
			</div>
			<div class="form-group">
				<label for="id">사진</label>
				<label><img src="http://localhost:8080/webPJ2020_1/IuploadFiles/<%=dto.getI_FILE()%>"><%=dto.getI_FILE() %></label>
			</div>
			<div class="form-group">
